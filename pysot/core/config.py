...
__C.DATASET.GOT10K.ROOT = ''
__C.DATASET.GOT10K.ANNO = ''
...
# Whether to use IRCA head
__C.IRCA.IRCA = False

# IRCA type
__C.IRCA.TYPE = 'MultiIRCA'

__C.IRCA.KWARGS = CN(new_allowed=True)
...
__C.TRACK.TYPE = 'SiamIRCATracker'
